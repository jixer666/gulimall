package com.ljx.gulimall.product.exception;

import com.ljx.common.exception.BizCodeEnume;
 ...
 */
@Slf4j
@RestControllerAdvice(basePackages = "com.ljx.gulimall.product.controller")
