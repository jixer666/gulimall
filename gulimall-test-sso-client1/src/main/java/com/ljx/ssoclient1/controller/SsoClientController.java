package com.ljx.ssoclient1.controller;
...
public class SsoClientController {
    ...
    public String employees(HttpSession session, HttpServletRequest request, Model model,
        ...
        if (Objects.isNull(user)){
            return "redirect:http://testssoserver.com:8080/login.html?redirect_url=http://testssoclient1.com:8081" + request.getRequestURI();
        }
